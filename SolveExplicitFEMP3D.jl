...
######################################################################
# Update Stress Last, UL formulation
######################################################################

function solve_explicit_dynamics_femp_3D(grid,solids,mats, basis,body,alg::USL,output,fixes,data)
...
# One point quadrature, precomputed basis and derivatives
######################################################################
